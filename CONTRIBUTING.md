...
LLM_GATEWAY_URL=https://llmgateway.local.xyz/v1 LLM_GATEWAY_API_KEY=<your_api_key> ./run-kaseki.sh
```
...
KASEKI_IMAGE=kaseki-template:latest LLM_GATEWAY_URL=https://llmgateway.local.xyz/v1 LLM_GATEWAY_API_KEY=<your_api_key> ./run-kaseki.sh
```
