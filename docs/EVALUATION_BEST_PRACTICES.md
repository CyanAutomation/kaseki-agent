...
- [ ] **Run-Evaluation**: Do `pr_changes` name concrete implementation changes grounded in `git.diff` or persisted evidence, with validation claims backed by exit codes and without repeating validation telemetry?
