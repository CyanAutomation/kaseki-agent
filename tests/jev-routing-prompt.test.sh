...
export KASEKI_JEV_TASK_TYPE=documentation
export KASEKI_JEV_VALIDATION_FOCUS=docs_checks
...
grep -q 'JEV advisory classification' <<< "$prompt"
...
printf '✓ JEV routing prompt stays advisory and preserves automatic flow\n'
