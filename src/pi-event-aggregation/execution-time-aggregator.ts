/**
 * Execution Time Aggregator
 *
 * Tracks wall time spent in API calls vs tool execution to identify
 * performance bottlenecks. Maintains per-API and per-tool breakdowns.
 */
